...
function deploy(){
    ...
    ssh -o "StrictHostKeyChecking no" -i  /tmp/sshkey.pem ${SSH_USER}@${DEPLOYMENT_SERVER} " sudo docker exec ${CONTAINER_NAME} chown -R www-data:www-data  /var/www/html/wp-content/plugins/froala/ && sleep 5 "
