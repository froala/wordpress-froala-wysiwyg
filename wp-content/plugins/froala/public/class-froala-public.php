...
class Froala_Editor {
	 ...
	 * @param array('option' => 'argument') $editor_options          Represents the options that the editor can take.
	 *
	 */
	public static function activate($element_selector= null, $editor_options = null) {
		...
		if ( $element_selector !== null) {
			...
			// De rezolvat asta altfel sa nu mai ajunga in response.
	...
	/**
	 * Injects the main javascript file that loads the Froala editor.
	 *
	 * @param null $content
	 */
